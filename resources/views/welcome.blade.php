                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="w"><img src="assets/img/logo/logo.png" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-7 col-md-9 ">
                                <div class="hero__caption">
                                    <h2 data-animation="fadeInLeft" data-delay=".4s">Let Your Business Grow Super Fast And Secure, With Techup</h2>
                                    <p data-animation="fadeInLeft" data-delay=".6s">Quia sed quod fuga tempora. Officiis voluptas asperiores numquam. Velit occaecati et et blanditiis ab placeat qui.
                                    Caecati et et blanditiis ab placeat qui. Clandit iis ab placeat qui.</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-do text-center mb-30">
                            ...
                            <div class="do-caption">
                                ...
                                <p>Molestiae eum conse qu atur beatae fugiat opt io nobis eaque assumenda. Velit consequatur volup</p>
                            </div>
                            <div class="do-btn">
                                <a href="#"><i class="ti-arrow-right"></i> Learn More</a>
                            </div>
                        </div>
                    </div>
                     <div class="col-lg-3 col-md-6">
                ...
                <div class="row d-flex align-items-end">
                    <div class="col-lg-6 col-md-12">
                        <div class="we-create-img">
                            <img src="assets/img//service/testing.gif" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="we-create-cap">
                            <h3>Encourage clients with endless rewarding!
                                For each contribution!</h3>
        ...
        <div class="generating-area ">
            <div class="container">
                 ...
                 <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-tittle text-center">
                            <h2>The best features to reach your business goals​​</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-8">
                        <div class="single-generating d-flex mb-30">
                            ...
                            <div class="generating-cap">
                                <h4>Idea</h4>
                                <p>Turn your idea from concept to Minimum Viable Product</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-8">
