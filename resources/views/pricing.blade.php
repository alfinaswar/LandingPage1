    ...
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico">
            ...
            <style>
                ...
                .custom-accordion .btn-custom:hover {
                    text-decoration: none;
                    color: #ffeb3b;
                }
                ...
                .custom-accordion .btn-custom:focus {
                    outline: none;
                    box-shadow: none;
                }
            </style>
                ...
                <div class="accordion custom-accordion" id="faqAccordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faqAccordion">
                            <div class="card-body">
                                We can support platforms integrated with Checkout, Billing, and Invoicing. We can’t support PaymentIntent users but if you’re a platform interested in building your own UI for one-off payments, we’d love to hear from you! We can support platforms integrated with Checkout, Billing, and Invoicing. We can’t support PaymentIntent users but if you’re a platform
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faqAccordion">
                            <div class="card-body">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus quis, animi consequatur sequi, sunt quam ex aut tempore dolorem veritatis totam blanditiis unde tenetur repellat enim, corporis dicta dolore harum?
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                <button class="btn-custom collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Do you support PO Box Address?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#faqAccordion">
                            <div class="card-body">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum veniam, eius in maxime tenetur soluta quae aspernatur! Nulla esse odit minima velit eum repellendus architecto hic? Minima accusantium commodi blanditiis.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header" id="headingFour">
                            <h2 class="mb-0">
                                <button class="btn-custom collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
